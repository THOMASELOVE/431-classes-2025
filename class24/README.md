...
- The [conflicted package](https://conflicted.r-lib.org/)
    - [Here](https://github.com/THOMASELOVE/431-classes-2025/blob/main/class24/31_conflicts.png) is a complete list of all 31 conflicts generated by `conflict_scout()` in our slides today.
