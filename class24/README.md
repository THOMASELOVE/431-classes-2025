...
- The [conflicted package](https://conflicted.r-lib.org/)
    - [Here is a complete list](https://github.com/THOMASELOVE/431-classes-2025/blob/main/class24/31_conflicts.png) of all 31 conflicts generated by `conflict_scout()` in Class 24 Slide 6 today.
