...
5. `data_tabulate()` from [datawizard](https://easystats.github.io/datawizard/reference/data_tabulate.html) in **easystats**
    - Andrew Crawford
6. `filter()` from [dplyr](https://dplyr.tidyverse.org/reference/filter.html) in **tidyverse**
...
13. `table()` from [base R](https://stat.ethz.ch/R-manual/R-devel/library/base/html/table.html)
    - Alex Bergendorf
14. `twoby2()` from [Epi](https://search.r-project.org/CRAN/refmans/Epi/html/twoby2.html)
    - Pooja Madan Mohan
