...
[^Lily]: Lily: You suggested that all `PAD790Q` values are 1 or more, but what about the zeros? Are you excluding them, and if so, why?
[^Ben]: Ben: I would treat the predictor as quantitative here, and assign 5 to all of the 5+ people. When possible, a quantitative key predictor is appealing for a variety of reasons.
[^Shufei]: Shufei and Ruoying: Since you didn't specify the NHANES variable names, I am assuming I have the right ones here. If I do not, then please let me know immediately.
